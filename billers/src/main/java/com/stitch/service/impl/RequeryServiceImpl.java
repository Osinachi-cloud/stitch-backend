...
//import com.stitch.vendor.vtpass.RequeryService;
...
//@Service
//@Slf4j
//public class RequeryServiceImpl implements RequeryService {
//
...
//
//    public RequeryServiceImpl(RestTemplate restTemplate) {
...
//    public VTPassRequeryResponse query(VTPassRequeryRequest request) {
//
//        log.debug("Doing requery for bill payment transaction: {}", request);
//
//        try {
//            String url = BASE_URL_VTPASS + "/requery";
//            HttpHeaders headers = getHeaders();
//            HttpEntity<?> entity = new HttpEntity<>(request, headers);
//
//            log.debug("Making API call to VTPass to requery transaction status at URL: {}", url);
//
//            ResponseEntity<VTPassRequeryResponse> response = restTemplate.exchange(url, HttpMethod.POST, entity, VTPassRequeryResponse.class);
//            log.debug("Requery response: {}", response);
//
...
//            }
//            throw new StitchApiException("Service error querying transaction status", e);
...
//        } catch (Exception e) {
//            throw new StitchApiException("Error querying transaction status", e);
//        }
//    }
//
