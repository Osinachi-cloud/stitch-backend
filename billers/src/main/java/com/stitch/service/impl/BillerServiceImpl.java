...
//                    .userId(airtimePaymentRequest.getCustomerId())
//                    .requestId(requestId)
...
//                    .userId(dataPaymentRequest.getCustomerId())
//                    .requestId(requestId)
...
//                    .userId(cableTvPaymentRequest.getCustomerId())
...
//
//            BillTransaction.BillTransactionBuilder billTransactionBuilder = BillTransaction.builder()
//                    .userId(electricityPaymentRequest.getCustomerId())
...
//                        .userId(paymentRequest.getCustomerId())
