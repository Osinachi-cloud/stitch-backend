...
public class TokenAuthenticationProvider {
    ...
    private final VendorUserDetailsServiceImpl vendorUserDetailsService;

    private final TokenUtils tokenUtils;

    public TokenAuthenticationProvider(@Qualifier("customerUserDetailsService") CustomUserDetailsServiceImpl customUserDetailsService, @Qualifier("vendorUserDetailsService") VendorUserDetailsServiceImpl vendorUserDetailsService, TokenUtils tokenUtils) {
...
//
//
//        UserDetails vendorDetails = vendorUserDetailsService.loadUserByUsername((String) claims.get("email"));
//
//        System.out.println("+++++++++++++++++++++++++++");
